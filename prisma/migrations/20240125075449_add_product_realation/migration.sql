...
-- AddForeignKey
ALTER TABLE `Product_Img` ADD CONSTRAINT `Product_Img_promotion_id_fkey` FOREIGN KEY (`promotion_id`) REFERENCES `Promotion`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
